...
export default function CinematicHome() {
  ...
  return <main ref={root} className="cinematic-home">
    <section className="ch-hero" aria-labelledby="ch-title">
      ...
      <div className="ch-hero-copy"><p className="ch-kicker">ONE STATE. LIMITLESS POTENTIAL.</p><h1 id="ch-title">WHERE<br/>MAHARASHTRA<br/><TypingText text="MEETS EXCELLENCE." delay={1900} /></h1><div className="ch-hero-support"><div><p className="ch-intro-copy">The ambition of a state.<br/>The spirit of every athlete.</p><Link className="ch-action" to="/events">Enter the action <ArrowUpRight/></Link></div><HeroLeadership/></div></div>
