...
export default function CinematicHome() {
  ...
  const heroImage = sportRecords.find(s=>s.imageUrl)?.imageUrl || athletes.find(a=>a.imageUrl)?.imageUrl || '/balewadistadium.webp';
  return <main ref={root} className="cinematic-home">
    <section className="ch-hero" aria-labelledby="ch-title">
      ...
      <figure className="ch-hero-portrait">
        <img src={heroImage} alt="Sport in Maharashtra" fetchPriority="high" />
        <figcaption><span>MAHARASHTRA / IN FOCUS</span><span>THE SPIRIT<br/>NEVER STANDS STILL.</span></figcaption>
        <span className="ch-image-index" aria-hidden="true">01</span>
      </figure>
    ...
    <div className="ch-rally-strip" aria-label="One state. Every sport.">
      <span>ONE STATE.</span><span aria-hidden="true">↗</span><span>EVERY SPORT.</span><span aria-hidden="true">↗</span><a href="#ch-sports">FIND YOUR DISCIPLINE <ArrowDown size={20}/></a>
    </div>
